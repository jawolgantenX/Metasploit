...
echo "     |  ___  I   I     awokawok       :) "
echo "     I  I  jawolgantenX  ######)"
echo "     I  I   I  I   I++++++++++++++)"
echo "     I  ___  I   kutuliskan tentang "
echo "     I ____ I   caraku menemukan"
echo "     1+2=3   dirimu......  1+2=3    "
echo "      DDOS   tentang apa yang $"
echo
echo
echo
echo
...
echo "       -{ Termos - Metaslpoit  } "
echo "     -{ KoREX-T3M3N TEAM   } "
echo ""
echo ""
echo "apa cita cita anda anjing"
echo ""
echo "[1] Anda ingin jadi hemkel"
echo "[2] Anda ingin menjadi hengker"
echo "[3] langsung menjadi hengkel"
echo ""
echo "--------------------------------------------------------------"
echo "Syaratnya beli topeng anonymous dulu "
echo "--------------------------------------------------------------"
echo ""
...
echo "Thanx  jawolgantenX"
echo ""
echo "atas support nya ngentod"
echo "tod..tod...tod.."
echo " KoREX-T3MEN TEAM  "
echo "
...
"
echo " Untuk menjadi hacker jalankan command ini tod :=> msfconsole"
